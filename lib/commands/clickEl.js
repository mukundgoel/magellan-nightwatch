...
util.inherits(ClickSettledElement, CheckVisibleAndClick);
...
ClickSettledElement.prototype.checkConditions = function() {
  ...
  this.execute(this.checkVisibleAndDo, [self.selector, {shouldClick:true}], function(result) {
    if (settings.verbose) {
